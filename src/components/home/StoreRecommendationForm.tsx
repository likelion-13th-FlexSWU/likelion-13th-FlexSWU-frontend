...
import selected1Icon from '../../assets/step-1-active.svg'
import unselected2Icon from '../../assets/step-2-inactive.svg'
import unselected3Icon from '../../assets/step-3-inactive.svg'
...
const StoreRecommendationForm: React.FC = () => {
  ...
  return (
    <div className="store-recommendation-container">
      {/* 상단 헤더 */}
      <header className="store-recommendation-header">
        <button className="store-recommendation-back-button" onClick={handleBack}>
          <img src={backArrowIcon} alt="뒤로가기" width="18" height="17" />
        </button>
        <h1 className="store-recommendation-title">가게 추천</h1>
        <div className="store-recommendation-header-spacer"></div>
      </header>
      ...
      {/* 메인 콘텐츠 */}
      <main className="store-recommendation-content">
      ...
      {/* 하단 버튼 */}
      <footer className="store-recommendation-footer">
        <button 
          className={`store-recommendation-next-button ${selectedCategory ? 'active' : 'disabled'}`}
          onClick={handleNext}
...
export default StoreRecommendationForm
